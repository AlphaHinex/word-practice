var words = [
    ...
    {
        "chinese": "移动",
        "desc": "可以根据发音记忆，'moo'的音类似牛叫，'ve'的音比较短促。",
        "english": "move",
        "phonetic": "/muːv/",
        "tag": "-test2"
    },
    {
        "chinese": "森林",
        "desc": "联想'for'（为了）和'est'（表示最高级），森林是很多生物赖以生存的地方，是很重要的。",
        "english": "forest",
        "phonetic": "/ˈfɔːrɪst/",
        "tag": "-test2"
    },
    {
        "chinese": "正常的",
        "desc": "注意字母组合'or'的发音，记忆时可联想反义词'abnormal'（不正常的）。",
        "english": "normal",
        "phonetic": "/ˈnɔːrml/",
        "tag": "-test2"
    },
    ...
    {
        "chinese": "冰川",
        "desc": "由'ice'（冰）和'berg'（山）组成，联想成冰做的山就是冰川。",
        "english": "iceberg",
        "phonetic": "/ˈaɪsbɜːrɡ/",
        "tag": "-test2"
    },
    {
        "chinese": "令人害怕的",
        "desc": "结合'scare'（使害怕）来记忆，'y'结尾表示形容词。",
        "english": "scary",
        "phonetic": "/ˈskeəri/",
        "tag": "-test2"
    },
    {
        "chinese": "沙漠",
        "desc": "可根据发音记忆，'de'发/de/，'sert'发/zərt/。",
        "english": "desert",
        "phonetic": "/ˈdezərt/",
        "tag": "-test2"
    },
    {
        "chinese": "岛屿",
        "desc": "拆分记忆，'is'和'land'（陆地），岛屿是四面环水的陆地。",
        "english": "island",
        "phonetic": "/ˈaɪlənd/",
        "tag": "-test2"
    },
    {
        "chinese": "假期",
        "desc": "联想'v'（胜利）的手势，放假了是胜利的时刻，可以尽情享受。",
        "english": "vacation",
        "phonetic": "/veɪˈkeɪʃn/",
        "tag": "-test2"
    },
    ...
    {
        "chinese": "享受,喜欢",
        "desc": "记忆时可联想'joy'（快乐），享受时是快乐的。",
        "english": "enjoy",
        "phonetic": "/ɪnˈdʒɔɪ/",
        "tag": "-test2"
    },
    {
        "chinese": "此英文内容拼写错误，无对应翻译",
        "desc": "",
    ...
    {
        "chinese": "肖像画",
        "desc": "联想'port'（港口）和'rait'（类似right），港口可能会有很多人物，适合画肖像画。",
        "english": "portrait",
        "phonetic": "/ˈpɔːrtrət/",
        "tag": "-test2"
    },
    {
        "chinese": "抽象画",
        "desc": "可根据'abstract'（抽象的）和'art'（艺术）的词义来理解记忆。",
    ...
    {
        "chinese": "金字塔",
        "desc": "根据发音记忆，'pyr'发/pɪr/，'amid'发/əmɪd/。",
        "english": "pyramid",
        "phonetic": "/ˈpɪrəmɪd/",
        "tag": "-test2"
    },
